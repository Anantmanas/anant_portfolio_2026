...
export const EXPERIENCE = [
  { role: "Freelance Full Stack Engineer", org: "Self-Employed · Remote", date: "Feb 2024 — Present" },
  { role: "Software Developer", org: "Radical Minds Technology", date: "Apr 2022 — Dec 2023" },
  { role: "UI Developer", org: "SM Web Solutions", date: "Oct 2020 — Feb 2022" },
];

export const AWARDS = [
  { year: "2025", title: "Featured Developer", org: "GitHub Trending", note: "PromptEnhance open-source release hit top-10 weekly trending." },
  { year: "2024", title: "Honorable Mention", org: "Awwwards", note: "Creative Agency site — motion & typography." },
